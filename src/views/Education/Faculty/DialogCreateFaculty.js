...
import {changeCreateFaculty} from "../../../redux/actions/facultyActions";
class DialogCreateFaculty extends React.Component {
    state = {
        faculty_code : "",
        faculty_name : "",
        faculty_description : "",
    ...
    SubmitForm(e){
        ...
        this.props.dispatch(changeCreateFaculty(form))
        this.setState({open: false});
    }
    render() {
        return (
...
export default connect()(DialogCreateFaculty)
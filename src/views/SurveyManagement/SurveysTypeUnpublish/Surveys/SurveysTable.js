...
class SurveysTable extends Component {
    preveus() {
        this.props.dispatch(preveusPagesSurveys('unpublish'))
    }

    goTo() {
        this.props.dispatch(nextPagesSurveys('unpublish'))
    }

    changePageSize(e) {
        this.props.dispatch(changePageSize(e.target.value,'unpublish'))
    }
